...
const projects = [
    { img: '/img/unc-comm.png', title: 'Commerce Website', desc: 'A Commerce site built with react that checks out using Whatsapp', tags: ['Tailwind', 'React', 'javascript'], link: 'https://uncle-chuks-site-pms2.vercel.app/' },
    { img: '/img/Screenshot 2026-01-23 at 7.21.33 PM.png', title: 'Sehembztravels', desc: 'Travel booking platform with seamless ticket reservations and planning.', tags: ['Next.js', 'Tailwind', 'Typescript'], link: 'https://sehembztravels.com/' },
